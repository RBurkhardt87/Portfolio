    ...
    <div>
      <div className='project-info-container'></div>
        ...
        <div className='section-stack'>
          <div className='section-text'>
            ...
            <ul>
              ...
              <li><b>Project Presentation</b> — <a href="https://docs.google.com/presentation/d/1Q6HOewM0bPnU61V9ypXlkjknPRM4q6VMtil-CI6yPhs/present" target="_blank" >Media Wrangler Slideshow</a></li>
            </ul>
          </div>
          <br />
          <div className='section-text'>
            ...
            <ul>
              ...
              <li><b>External API: </b>The Movie Database (TMDB)</li>
            </ul>     
          </div>          
        </div>
        <br />
        ...
        <br />
          ...
          <h4><b>Back to </b><a href="/projects">Project List</a></h4>     
    </div>
  )
}
